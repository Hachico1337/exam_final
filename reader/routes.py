...
from reader.models import Books
...
def index():
    ...
    books = Books.query.order_by(Books.created_at.desc()).paginate(page=page, per_page=4)
...
def best():
    page = request.args.get('page', 1, type=int)
    books = Books.query.filter(Books.rating > 4).paginate(page=page, per_page=4)
